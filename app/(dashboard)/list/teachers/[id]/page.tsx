            ...
            <div className="w-full xl:w-1/3 flex flex-col gap-4">
                <div className="bg-white p-4 rounded-md">
                    ...
                    <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                        <Link className="p-3 rounded-md bg-lamaSkyLight" href="" >Teacher&rsquo;s Classes</Link>
                        <Link className="p-3 rounded-md bg-lamaPurpleLight" href="" >Teacher&rsquo;s Students</Link>
                        <Link className="p-3 rounded-md bg-lamaYellowLight" href="" >Teacher&rsquo;s Lessons</Link>
                        <Link className="p-3 rounded-md bg-pink-50" href="" >Teacher&rsquo;s Exams</Link>
                        <Link className="p-3 rounded-md bg-lamaSkyLight" href="" >Teacher&rsquo;s Assignments</Link>
                    </div>
                </div>
                <Performance />
                <Announcements />
