...
const schema = z.object({
    username: z.string().min(3, { message: 'UserName must ne at least 3 characters long!' })
        .max(20, { message: 'UserName must ne at most 20 characters long!' }),
...
const TeacherFrom = ({ type, data }: { type: "create" | "update"; data?: any }) => {
    const {
        register,
        handleSubmit,
        formState: { errors },
